...
public class AndroidGL30 extends AndroidGL20 implements GL30 {
	...
	public void glTexImage3D(int target, int level, int internalformat,
		...
		GLES30.glTexImage3D(target, level, internalformat, width, height,
	...
	public void glTexImage3D(int target, int level, int internalformat,
			...
			int offset) {
		GLES30.glTexImage3D(target, level, internalformat, width, height,
				depth, border, format, type, offset);
	}
	...
	public void glTexSubImage3D(int target, int level, int xoffset,
		...
		GLES30.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width,
	...
	public void glCopyTexSubImage3D(int target, int level, int xoffset,
		...
		GLES30.glCopyTexSubImage3D(target, level, xoffset, yoffset, zoffset, x,
				y, width, height);
	}
	...
	public void glCompressedTexImage3D(int target, int level,
		...
		GLES30.glCompressedTexImage3D(target, level, internalformat, width,
	...
	public void glCompressedTexSubImage3D(int target, int level, int xoffset,
		...
		GLES30.glCompressedTexSubImage3D(target, level, xoffset, yoffset,
				zoffset, width, height, depth, format, imageSize, offset);
	}
	...
	public void glBlitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1,
		...
		GLES30.glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0,
	...
	public void glFramebufferTextureLayer(int target, int attachment,
		...
		GLES30.glFramebufferTextureLayer(target, attachment, texture, level,
				layer);
	}

	@Override
	public java.nio.Buffer glMapBufferRange(int target, int offset, int length,
			int access) {
	...
	public void glGetTransformFeedbackVarying(int program, int index,
			...
			int nameOffset) {
		GLES30.glGetTransformFeedbackVarying(program, index, bufsize, length,
	...
	@Override
	public void glGetTransformFeedbackVarying(int program, int index,
			int bufsize, java.nio.IntBuffer length, java.nio.IntBuffer size,
	...
	public String glGetTransformFeedbackVarying(int program, int index,
		...
		return GLES30.glGetTransformFeedbackVarying(program, index, size,
				sizeOffset, type, typeOffset);
	}
	...
	public void glCopyBufferSubData(int readTarget, int writeTarget,
		...
		GLES30.glCopyBufferSubData(readTarget, writeTarget, readOffset,
				writeOffset, size);
	}
	...
	public void glGetActiveUniformsiv(int program, int uniformCount,
			int[] uniformIndices, int uniformIndicesOffset, int pname,
			int[] params, int paramsOffset) {
		GLES30.glGetActiveUniformsiv(program, uniformCount, uniformIndices,
				uniformIndicesOffset, pname, params, paramsOffset);
	}

	@Override
	public void glGetActiveUniformsiv(int program, int uniformCount,
			java.nio.IntBuffer uniformIndices, int pname,
			java.nio.IntBuffer params) {
		GLES30.glGetActiveUniformsiv(program, uniformCount, uniformIndices,
				pname, params);
	}
	...
	public void glGetActiveUniformBlockiv(int program, int uniformBlockIndex,
		...
		GLES30.glGetActiveUniformBlockiv(program, uniformBlockIndex, pname,
				params, offset);
	}
	...
	public void glGetActiveUniformBlockName(int program, int uniformBlockIndex,
		...
		GLES30.glGetActiveUniformBlockName(program, uniformBlockIndex, bufSize,
				length, lengthOffset, uniformBlockName, uniformBlockNameOffset);
	}

	@Override
	public void glGetActiveUniformBlockName(int program, int uniformBlockIndex,
			java.nio.Buffer length, java.nio.Buffer uniformBlockName) {
		GLES30.glGetActiveUniformBlockName(program, uniformBlockIndex, length,
				uniformBlockName);
	}
	...
	public void glUniformBlockBinding(int program, int uniformBlockIndex,
		...
		GLES30.glUniformBlockBinding(program, uniformBlockIndex,
				uniformBlockBinding);
	}
	...
	public void glDrawElementsInstanced(int mode, int count, int type,
		...
		GLES30.glDrawElementsInstanced(mode, count, type, indices,
				instanceCount);
	}
	...
	public void glDrawElementsInstanced(int mode, int count, int type,
		...
		GLES30.glDrawElementsInstanced(mode, count, type, indicesOffset,
				instanceCount);
	}
	...
	public void glGetSynciv(long sync, int pname, int bufSize, int[] length,
			int lengthOffset, int[] values, int valuesOffset) {
		GLES30.glGetSynciv(sync, pname, bufSize, length, lengthOffset, values,
				valuesOffset);
	}

	@Override
	public void glGetSynciv(long sync, int pname, int bufSize,
			java.nio.IntBuffer length, java.nio.IntBuffer values) {
	...
	@Override
	public void glGetInteger64i_v(int target, int index,
	...
	@Override
	public void glSamplerParameteriv(int sampler, int pname,
	...
	@Override
	public void glSamplerParameterfv(int sampler, int pname,
	...
	@Override
	public void glGetSamplerParameteriv(int sampler, int pname,
			java.nio.IntBuffer params) {
	...
	public void glGetProgramBinary(int program, int bufSize, int[] length,
		...
		GLES30.glGetProgramBinary(program, bufSize, length, lengthOffset,
				binaryFormat, binaryFormatOffset, binary);
	}
	...
	public void glGetProgramBinary(int program, int bufSize,
			...
			java.nio.Buffer binary) {
		GLES30.glGetProgramBinary(program, bufSize, length, binaryFormat,
				binary);
	}
	...
	public void glInvalidateSubFramebuffer(int target, int numAttachments,
			int[] attachments, int offset, int x, int y, int width, int height) {
		GLES30.glInvalidateSubFramebuffer(target, numAttachments, attachments,
				offset, x, y, width, height);
	}

	@Override
	public void glInvalidateSubFramebuffer(int target, int numAttachments,
			java.nio.IntBuffer attachments, int x, int y, int width, int height) {
		GLES30.glInvalidateSubFramebuffer(target, numAttachments, attachments,
				x, y, width, height);
	}
	...
	public void glTexStorage3D(int target, int levels, int internalformat,
		...
		GLES30.glTexStorage3D(target, levels, internalformat, width, height,
				depth);
	}

	@Override
	public void glGetInternalformativ(int target, int internalformat,
			int pname, int bufSize, int[] params, int offset) {
		GLES30.glGetInternalformativ(target, internalformat, pname, bufSize,
				params, offset);
	}

	@Override
	public void glGetInternalformativ(int target, int internalformat,
			int pname, int bufSize, java.nio.IntBuffer params) {
		GLES30.glGetInternalformativ(target, internalformat, pname, bufSize,
				params);
	}
