...
package com.glview.libgdx.graphics;
...
import com.glview.libgdx.graphics.glutils.IndexArray;
import com.glview.libgdx.graphics.glutils.IndexBufferObject;
import com.glview.libgdx.graphics.glutils.IndexBufferObjectSubData;
import com.glview.libgdx.graphics.glutils.IndexData;
import com.glview.libgdx.graphics.glutils.ShaderProgram;
import com.glview.libgdx.graphics.glutils.VertexArray;
import com.glview.libgdx.graphics.glutils.VertexBufferObject;
import com.glview.libgdx.graphics.glutils.VertexBufferObjectSubData;
import com.glview.libgdx.graphics.glutils.VertexData;
import com.glview.libgdx.graphics.math.BoundingBox;
...
public class Mesh implements Disposable {
	...
	public static boolean forceVBO = true;
...
// if (type == VertexDataType.VertexArray && App.getGL20() != null) type = VertexDataType.VertexBufferObject;
	...
	public void bind (final ShaderProgram shader, final int[] locations) {
		if (App.getGL20() == null) throw new IllegalStateException("can't use this render method with OpenGL ES 1.x");
	...
	public void calculateBoundingBox (BoundingBox bbox) {
		...
		if (numVertices == 0) throw new GLViewRuntimeException("No vertices defined");
	...
	public BoundingBox extendBoundingBox(final BoundingBox out, int offset, int count, final Matrix4 transform) {
		...
		if (offset < 0 || count < 1 || offset + count > numIndices)
			throw new GLViewRuntimeException("Not enough indices");
