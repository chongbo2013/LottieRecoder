...
public class ViewConfiguration {
    ...
    private ViewConfiguration(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB && config.isLayoutSizeAtLeast(Configuration.SCREENLAYOUT_SIZE_XLARGE)) {
...
//            IWindowManager wm = WindowManagerGlobal.getWindowManagerService();
            try {
                sHasPermanentMenuKey = false;//!wm.hasNavigationBar();
    ...
    public static int getLongPressTimeout() {
        return /*AppGlobals.getIntCoreSetting(Settings.Secure.LONG_PRESS_TIMEOUT,
                DEFAULT_LONG_PRESS_TIMEOUT)*/DEFAULT_LONG_PRESS_TIMEOUT;
    }
