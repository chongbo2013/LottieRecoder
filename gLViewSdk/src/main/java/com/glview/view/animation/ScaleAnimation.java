...
public class ScaleAnimation extends Animation {
    ...
    public ScaleAnimation(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.glview.R.styleable.ScaleAnimation);

        TypedValue tv = a.peekValue(
                com.glview.R.styleable.ScaleAnimation_fromXScale);
        mFromX = 0.0f;
        if (tv != null) {
        ...
        tv = a.peekValue(
                com.glview.R.styleable.ScaleAnimation_toXScale);
        mToX = 0.0f;
        if (tv != null) {
            if (tv.type == TypedValue.TYPE_FLOAT) {
                // This is a scaling factor.
        ...
        tv = a.peekValue(
                com.glview.R.styleable.ScaleAnimation_fromYScale);
        mFromY = 0.0f;
        if (tv != null) {
            if (tv.type == TypedValue.TYPE_FLOAT) {
                // This is a scaling factor.
        ...
        tv = a.peekValue(
                com.glview.R.styleable.ScaleAnimation_toYScale);
        mToY = 0.0f;
        if (tv != null) {
            if (tv.type == TypedValue.TYPE_FLOAT) {
                // This is a scaling factor.
        ...
        Description d = Description.parseValue(a.peekValue(
                com.glview.R.styleable.ScaleAnimation_pivotX));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = Description.parseValue(a.peekValue(
            com.glview.R.styleable.ScaleAnimation_pivotY));
        mPivotYType = d.type;
...
//            t.getMatrix().setScale(sx, sy);
        	canvas.scale(sx, sy, 1.0f);
        } else {
//            t.getMatrix().setScale(sx, sy, scale * mPivotX, scale * mPivotY);
        	//TODO:是否有必要支持下面的功能 mPivotX mPivotY功能
        	canvas.scale(sx, sy, 1.0f);
        }
