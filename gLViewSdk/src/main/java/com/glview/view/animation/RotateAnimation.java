...
public class RotateAnimation extends Animation {
    ...
    public RotateAnimation(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.glview.R.styleable.RotateAnimation);

        mFromDegrees = a.getFloat(
                com.glview.R.styleable.RotateAnimation_fromDegrees, 0.0f);
        mToDegrees = a.getFloat(com.glview.R.styleable.RotateAnimation_toDegrees, 0.0f);

        Description d = Description.parseValue(a.peekValue(
            com.glview.R.styleable.RotateAnimation_pivotX));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = Description.parseValue(a.peekValue(
            com.glview.R.styleable.RotateAnimation_pivotY));
        mPivotYType = d.type;
