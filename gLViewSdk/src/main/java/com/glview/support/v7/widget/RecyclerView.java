...
import com.glview.support.v7.widget.AdapterHelper.Callback;
import com.glview.support.v7.widget.AdapterHelper.UpdateOp;
...
import com.glview.widget.EdgeEffect;
import com.glview.widget.Scroller;
...
public class RecyclerView extends ViewGroup {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setWillNotDraw(getOverScrollMode() == OVER_SCROLL_NEVER);
     ...
     * {@link com.glview.support.v7.widget.v7.widget.RecyclerView.LayoutManager#scrollToPosition(int)}
     * @param position Scroll to this adapter position
     * @see com.glview.support.v7.widget.v7.widget.RecyclerView.LayoutManager#scrollToPosition(int)
     */
     ...
     * @see com.glview.support.v7.widget.v7.widget.RecyclerView.LayoutManager#computeHorizontalScrollOffset
     ...
     * @see com.glview.support.v7.widget.v7.widget.RecyclerView.LayoutManager#computeVerticalScrollOffset
     * (RecyclerView.Adapter)
     */
    @Override
    ...
    private void releaseGlows() {
        ...
        if (mLeftGlow != null) mLeftGlow.onRelease();
        if (mTopGlow != null) mTopGlow.onRelease();
        if (mRightGlow != null) mRightGlow.onRelease();
    ...
    public ViewHolder getChildViewHolder(View child) {
        final ViewGroup parent = child.getParent();
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
         ...
         * {@link com.glview.support.v7.widget.v7.widget.RecyclerView.AdapterDataObserver#onChanged()
    ...
    public static abstract class LayoutManager {
        ...
        public boolean requestChildRectangleOnScreen(RecyclerView parent, View child, Rect rect,
            ...
            final int dx;
            if (parent.getLayoutDirection() == ViewGroup.LAYOUT_DIRECTION_RTL) {
    ...
    public static abstract class ItemDecoration {
         ...
         * @param state The current state of RecyclerView
         */
        public void onDraw(GLCanvas c, RecyclerView parent, State state) {
            onDraw(c, parent);
        }
         ...
         */
        @Deprecated
        public void onDraw(GLCanvas c, RecyclerView parent) {
        }
         ...
         * @param state The current state of RecyclerView.
         */
        public void onDrawOver(GLCanvas c, RecyclerView parent, State state) {
            onDrawOver(c, parent);
        }
         ...
         */
        @Deprecated
        public void onDrawOver(GLCanvas c, RecyclerView parent) {
        }
     ...
     */
    public static class LayoutParams extends com.glview.view.ViewGroup.MarginLayoutParams {
