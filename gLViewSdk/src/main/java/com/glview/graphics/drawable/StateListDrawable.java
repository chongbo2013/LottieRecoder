...
public class StateListDrawable extends DrawableContainer {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        final TypedArray a = obtainAttributes(r, attrs, R.styleable.StateListDrawable);
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            for (i = 0; i < numAttrs; i++) {
                ...
                if (stateResId == R.attr.drawable || stateResId == android.R.attr.drawable) {
            ...
            final Drawable dr;
            if (drawableRes != 0) {
                dr = GLContext.get().getResources().getDrawable(drawableRes);//r.getDrawable(drawableRes, theme);
            } else {
