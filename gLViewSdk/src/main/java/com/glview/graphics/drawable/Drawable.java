...
public abstract class Drawable {
     ...
     *
     * @see #copyBounds()
     * @see #copyBounds(com.glview.graphics.Rect)
     */
     ...
     */
    public static Drawable createFromResourceStream(Resources res, TypedValue value,
            InputStream is, String srcName, Options opts) {
    	return createFromResourceStream(res, value, is, srcName, opts, false);
    }
     ...
     */
    public static Drawable createFromResourceStream(Resources res, TypedValue value,
            InputStream is, String srcName, Options opts, boolean fromAsset) {
        if (is == null) {
            return null;
        }
...
//                ? res.getDisplayMetrics().noncompatDensityDpi : DisplayMetrics.DENSITY_DEVICE;
        Bitmap  bm = fromAsset ? BitmapFactory.decodeResourceStream(res, value, is, pad, srcName, opts) : BitmapFactory.decodeResourceStream(res, value, is, pad, opts);
        if (bm != null) {
...
//            bm.getOpticalInsets(opticalInsets);
    ...
    static TypedArray obtainAttributes(
            Resources res, AttributeSet set, int[] attrs) {
