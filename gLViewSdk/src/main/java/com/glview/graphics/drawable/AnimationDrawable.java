...
public class AnimationDrawable extends DrawableContainer implements Runnable, Animatable {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        TypedArray a = obtainAttributes(r, attrs,
                com.glview.R.styleable.AnimationDrawable);

        super.inflateWithAttributes(r, parser, a,
        		com.glview.R.styleable.AnimationDrawable_visible);

        mAnimationState.setVariablePadding(a.getBoolean(
        		com.glview.R.styleable.AnimationDrawable_variablePadding, false));

        mAnimationState.mOneShot = a.getBoolean(
        		com.glview.R.styleable.AnimationDrawable_oneshot, false);
        ...
        while ((type=parser.next()) != XmlPullParser.END_DOCUMENT &&
            ...
            a = obtainAttributes(
                    r, attrs, com.glview.R.styleable.AnimationDrawableItem);
            int duration = a.getInt(
            		com.glview.R.styleable.AnimationDrawableItem_duration, -1);
            if (duration < 0) {
            ...
            int drawableRes = a.getResourceId(
            		com.glview.R.styleable.AnimationDrawableItem_drawable, 0);

            a.recycle();

            Drawable dr;
            if (drawableRes != 0) {
                dr = GLContext.get().getResources().getDrawable(drawableRes);
            } else {
