...
public class LayerDrawable extends Drawable implements Drawable.Callback {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        final TypedArray a = obtainAttributes(r, attrs, com.glview.R.styleable.LayerDrawable);
    ...
    private void updateStateFromTypedArray(TypedArray a) {
        ...
        mOpacityOverride = a.getInt(com.glview.R.styleable.LayerDrawable_opacity, mOpacityOverride);

        state.mAutoMirrored = a.getBoolean(com.glview.R.styleable.LayerDrawable_autoMirrored,
                state.mAutoMirrored);
//        state.mPaddingMode = a.getInteger(com.glview.R.styleable.LayerDrawable_paddingMode,
//                state.mPaddingMode);
    }
     ...
     */
    private void inflateLayers(Resources r, XmlPullParser parser, AttributeSet attrs)
            throws XmlPullParserException, IOException {
        final LayerState state = mLayerState;
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            final TypedArray a = obtainAttributes(r, attrs, com.glview.R.styleable.LayerDrawableItem);
    ...
    private void updateLayerFromTypedArray(ChildDrawable layer, TypedArray a) {
        ...
        layer.mInsetL = a.getDimensionPixelOffset(
        		com.glview.R.styleable.LayerDrawableItem_left, layer.mInsetL);
        layer.mInsetT = a.getDimensionPixelOffset(
        		com.glview.R.styleable.LayerDrawableItem_top, layer.mInsetT);
        layer.mInsetR = a.getDimensionPixelOffset(
        		com.glview.R.styleable.LayerDrawableItem_right, layer.mInsetR);
        layer.mInsetB = a.getDimensionPixelOffset(
        		com.glview.R.styleable.LayerDrawableItem_bottom, layer.mInsetB);
        layer.mId = a.getResourceId(com.glview.R.styleable.LayerDrawableItem_id, layer.mId);

        final Drawable dr = GLContext.get().getResources().getDrawable(a.getResourceId(com.glview.R.styleable.LayerDrawableItem_drawable, 0));
        if (dr != null) {
            layer.mDrawable = dr;
        }
    }
