...
public class RotateDrawable extends Drawable implements Drawable.Callback {
    ...
    public void draw(GLCanvas canvas) {
        ...
        canvas.rotate(st.mCurrentDegrees, 0, 0, 1);
        canvas.translate(- (px + bounds.left), - (py + bounds.top));
        d.draw(canvas);
        canvas.restore();
    }
   ...
   @Override
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        final TypedArray a = obtainAttributes(r, attrs,
                com.glview.R.styleable.RotateDrawable);

        super.inflateWithAttributes(r, parser, a,
        		com.glview.R.styleable.RotateDrawable_visible);

        TypedValue tv = a.peekValue(com.glview.R.styleable.RotateDrawable_pivotX);
        ...
        tv = a.peekValue(com.glview.R.styleable.RotateDrawable_pivotY);
        ...
        final float fromDegrees = a.getFloat(
        		com.glview.R.styleable.RotateDrawable_fromDegrees, 0.0f);
        final float toDegrees = a.getFloat(
        		com.glview.R.styleable.RotateDrawable_toDegrees, 360.0f);

        final int res = a.getResourceId(
        		com.glview.R.styleable.RotateDrawable_drawable, 0);
