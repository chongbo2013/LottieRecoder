    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            TypedArray a = obtainAttributes(r, attrs,
                    com.glview.R.styleable.LevelListDrawableItem);

            low = a.getInt(
            		com.glview.R.styleable.LevelListDrawableItem_minLevel, 0);
            int high = a.getInt(
            		com.glview.R.styleable.LevelListDrawableItem_maxLevel, 0);
            int drawableRes = a.getResourceId(
            		com.glview.R.styleable.LevelListDrawableItem_drawable, 0);
