...
public class AnimatedRotateDrawable extends Drawable implements Drawable.Callback, Runnable,
    ...
    public void draw(GLCanvas canvas) {
        ...
        canvas.translate(px + bounds.left, py + bounds.top);
        canvas.rotate(mCurrentDegrees, 0, 0, 1);
        canvas.translate(- (px + bounds.left), - (py + bounds.top));
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        final TypedArray a = obtainAttributes(r, attrs, com.glview.R.styleable.AnimatedRotateDrawable);

        super.inflateWithAttributes(r, parser, a, com.glview.R.styleable.AnimatedRotateDrawable_visible);

        TypedValue tv = a.peekValue(com.glview.R.styleable.AnimatedRotateDrawable_pivotX);
        ...
        tv = a.peekValue(com.glview.R.styleable.AnimatedRotateDrawable_pivotY);
        ...
        setFramesCount(a.getInt(com.glview.R.styleable.AnimatedRotateDrawable_framesCount, 12));
        setFramesDuration(a.getInt(com.glview.R.styleable.AnimatedRotateDrawable_frameDuration, 150));

        final int res = a.getResourceId(com.glview.R.styleable.AnimatedRotateDrawable_drawable, 0);
        Drawable drawable = null;
        if (res > 0) {
            drawable = GLContext.get().getResources().getDrawable(res);
        }
