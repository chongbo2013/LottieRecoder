...
public class ScaleDrawable extends Drawable implements Drawable.Callback {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        TypedArray a = obtainAttributes(
                r, attrs, com.glview.R.styleable.ScaleDrawable);

        float sw = getPercent(a, com.glview.R.styleable.ScaleDrawable_scaleWidth);
        float sh = getPercent(a, com.glview.R.styleable.ScaleDrawable_scaleHeight);
        int g = a.getInt(com.glview.R.styleable.ScaleDrawable_scaleGravity, Gravity.LEFT);
        boolean min = a.getBoolean(
        		com.glview.R.styleable.ScaleDrawable_useIntrinsicSizeAsMinimum, false);
        Drawable dr = GLContext.get().getResources().getDrawable(a.getResourceId(com.glview.R.styleable.ScaleDrawable_drawable, 0));
