...
import com.glview.animation.Animator.AnimatorListener;
import com.glview.animation.AnimatorListenerAdapter;
import com.glview.animation.AnimatorSet;
import com.glview.animation.IntProperty;
import com.glview.animation.ObjectAnimator;
import com.glview.animation.PropertyValuesHolder;
...
//        }
        ...
        if (mTextSize > 0) {
            mPrimaryText.setTextSize(mTextSize);
            mSecondaryText.setTextSize(mTextSize);
        }
...
//        mSecondaryText.setIncludeFontPadding(false);
    ...
    public void setStyle(int resId) {
        ...
        final TypedArray ta = context.obtainStyledAttributes(null,
                com.glview.R.styleable.FastScroll, com.glview.R.attr.fastScrollStyle, resId);
