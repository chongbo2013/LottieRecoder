...
public class HorizontalScrollView extends FrameLayout {
    ...
    public HorizontalScrollView(
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, com.glview.R.styleable.HorizontalScrollView, defStyleAttr, defStyleRes);

        setFillViewport(a.getBoolean(com.glview.R.styleable.HorizontalScrollView_fillViewport, false));
...
//    }
    ...
    private static boolean isViewDescendantOf(View child, View parent) {
        ...
        return (theParent != null) && isViewDescendantOf((View) theParent, parent);
    }
