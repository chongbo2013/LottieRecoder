...
public class ListView extends AbsListView {
    ...
    public ListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.glview.R.styleable.ListView, defStyleAttr, defStyleRes);
        ...
        final Drawable d = GLContext.get().getResources().getDrawable(a.getResourceId(com.glview.R.styleable.ListView_gl_Divider, 0));//a.getDrawable(com.glview.R.styleable.ListView_divider);
        if (d != null) {
            // If a divider is specified use its intrinsic height for divider height
            setDivider(d);
        }
        
        final Drawable osHeader = GLContext.get().getResources().getDrawable(a.getResourceId(com.glview.R.styleable.ListView_overScrollHeader, 0));/*a.getDrawable(
                com.glview.R.styleable.ListView_overScrollHeader);*/
        if (osHeader != null) {
            setOverscrollHeader(osHeader);
        }

        final Drawable osFooter = GLContext.get().getResources().getDrawable(a.getResourceId(com.glview.R.styleable.ListView_overScrollFooter, 0));/*a.getDrawable(
                com.glview.R.styleable.ListView_overScrollFooter);*/
        if (osFooter != null) {
        ...
        final int dividerHeight = a.getDimensionPixelSize(
                com.glview.R.styleable.ListView_dividerHeight, 0);
        if (dividerHeight != 0) {
            setDividerHeight(dividerHeight);
        }

        mHeaderDividersEnabled = a.getBoolean(com.glview.R.styleable.ListView_headerDividersEnabled, true);
        mFooterDividersEnabled = a.getBoolean(com.glview.R.styleable.ListView_footerDividersEnabled, true);
...
//            cleanupLayoutState(child);
    ...
    private boolean isViewAncestorOf(View child, View parent) {
        ...
        final ViewGroup theParent = child.getParent();
    ...
    void drawOverscrollHeader(GLCanvas canvas, Drawable drawable, Rect bounds) {
...
//        canvas.clipRect(bounds);
    ...
    void drawOverscrollFooter(GLCanvas canvas, Drawable drawable, Rect bounds) {
        final int height = drawable.getMinimumHeight();
...
//        canvas.clipRect(bounds);
    ...
    protected void dispatchDraw(GLCanvas canvas) {
        ...
        if (drawDividers || drawOverscrollHeader || drawOverscrollFooter) {
            ...
            final GLPaint paint = mDividerPaint;
     ...
     *            drawn.
     */
    void drawDivider(GLCanvas canvas, Rect bounds, int childIndex) {
