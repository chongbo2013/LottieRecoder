...
import com.glview.graphics.drawable.Animatable;
import com.glview.graphics.drawable.AnimationDrawable;
import com.glview.graphics.drawable.BitmapDrawable;
import com.glview.graphics.drawable.Drawable;
import com.glview.graphics.drawable.LayerDrawable;
import com.glview.graphics.drawable.StateListDrawable;
import com.glview.hwui.GLCanvas;
import com.glview.pool.Pool;
import com.glview.pool.Poolable;
import com.glview.view.View;
import com.glview.view.animation.AlphaAnimation;
...
import com.glview.view.animation.Transformation;
...
public class ProgressBar extends View {
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setMax(a.getInt(com.glview.R.styleable.ProgressBar_max, mMax));

        setProgress(a.getInt(com.glview.R.styleable.ProgressBar_progress, mProgress));
        ...
        mOnlyIndeterminate = a.getBoolean(
        		com.glview.R.styleable.ProgressBar_indeterminateOnly, mOnlyIndeterminate);
        ...
        /*if (a.hasValue(com.glview.R.styleable.ProgressBar_progressTintMode)) {
            if (mProgressTintInfo == null) {
                mProgressTintInfo = new ProgressTintInfo();
            }
            mProgressTintInfo.mProgressTintMode = Drawable.parseTintMode(a.getInt(
            		com.glview.R.styleable.ProgressBar_progressBackgroundTintMode, -1), null);
            mProgressTintInfo.mHasProgressTintMode = true;
        }

        if (a.hasValue(com.glview.R.styleable.ProgressBar_progressTint)) {
            if (mProgressTintInfo == null) {
                mProgressTintInfo = new ProgressTintInfo();
            }
            mProgressTintInfo.mProgressTintList = a.getColorStateList(
            		com.glview.R.styleable.ProgressBar_progressTint);
            mProgressTintInfo.mHasProgressTint = true;
        }

        if (a.hasValue(com.glview.R.styleable.ProgressBar_progressBackgroundTintMode)) {
            if (mProgressTintInfo == null) {
                mProgressTintInfo = new ProgressTintInfo();
            }
            mProgressTintInfo.mProgressBackgroundTintMode = Drawable.parseTintMode(a.getInt(
            		com.glview.R.styleable.ProgressBar_progressTintMode, -1), null);
            mProgressTintInfo.mHasProgressBackgroundTintMode = true;
        }

        if (a.hasValue(com.glview.R.styleable.ProgressBar_progressBackgroundTint)) {
            if (mProgressTintInfo == null) {
                mProgressTintInfo = new ProgressTintInfo();
            }
            mProgressTintInfo.mProgressBackgroundTintList = a.getColorStateList(
            		com.glview.R.styleable.ProgressBar_progressBackgroundTint);
            mProgressTintInfo.mHasProgressBackgroundTint = true;
        }

        if (a.hasValue(com.glview.R.styleable.ProgressBar_secondaryProgressTintMode)) {
            if (mProgressTintInfo == null) {
                mProgressTintInfo = new ProgressTintInfo();
            }
            mProgressTintInfo.mSecondaryProgressTintMode = Drawable.parseTintMode(
                    a.getInt(com.glview.R.styleable.ProgressBar_secondaryProgressTintMode, -1), null);
            mProgressTintInfo.mHasSecondaryProgressTintMode = true;
        }

        if (a.hasValue(com.glview.R.styleable.ProgressBar_secondaryProgressTint)) {
            if (mProgressTintInfo == null) {
                mProgressTintInfo = new ProgressTintInfo();
            }
            mProgressTintInfo.mSecondaryProgressTintList = a.getColorStateList(
            		com.glview.R.styleable.ProgressBar_secondaryProgressTint);
            mProgressTintInfo.mHasSecondaryProgressTint = true;
        }

        if (a.hasValue(com.glview.R.styleable.ProgressBar_indeterminateTint)) {
            if (mProgressTintInfo == null) {
                mProgressTintInfo = new ProgressTintInfo();
            }
            mProgressTintInfo.mIndeterminateTintMode = Drawable.parseTintMode(a.getInt(
            		com.glview.R.styleable.ProgressBar_indeterminateTintMode, -1), null);
        ...
        if (a.hasValue(com.glview.R.styleable.ProgressBar_indeterminateTint)) {
            ...
            mProgressTintInfo.mIndeterminateTintList = a.getColorStateList(
            		com.glview.R.styleable.ProgressBar_indeterminateTint);
...
//                    target.setTintMode(mProgressTintInfo.mProgressTintMode);
    ...
    private void applyProgressBackgroundTint() {
        if (mProgressTintInfo.mHasProgressBackgroundTint
            ...
            final Drawable target = getTintTarget(com.glview.R.id.background, false);
            if (target != null) {
                if (mProgressTintInfo.mHasProgressBackgroundTint) {
...
//                    target.setTintMode(mProgressTintInfo.mSecondaryProgressTintMode);
    ...
    private static class RefreshData implements Poolable {
        private static final int POOL_MAX = 24;
        private static final Pool<RefreshData> sPool =
                new Pool<RefreshData>(false);
        ...
        public static RefreshData obtain(int id, float progress, boolean fromUser,
                boolean animate) {
            RefreshData rd = (RefreshData) sPool.poll(RefreshData.class, false);
            if (rd == null) {
                rd = new RefreshData();
            }
            rd.id = id;
...
//        layer.setTintMode(tintMode);
    ...
    void setAnimationPosition(float position) {
        ...
        refreshProgress(android.R.id.progress, position, true, true);
    }
    ...
    void drawTrack(GLCanvas canvas) {
        ...
        if (d != null) {
            ...
            if (mHasAnimation) {
                mAnimation.getTransformation(time, canvas/*mTransformation*/);
