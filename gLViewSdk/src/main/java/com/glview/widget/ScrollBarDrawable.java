...
//        }
    ...
    protected void drawTrack(GLCanvas canvas, Rect bounds, boolean vertical) {
        Drawable track;
        if (vertical) {
    ...
    protected void drawThumb(GLCanvas canvas, Rect bounds, int offset, int length, boolean vertical) {
