...
import com.glview.graphics.drawable.TransitionDrawable;
 ...
 */
public abstract class AbsListView extends AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener, 
    ...
    public AbsListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mDrawSelectorOnTop = a.getBoolean(
        		com.glview.R.styleable.AbsListView_drawSelectorOnTop, false);

        boolean stackFromBottom = a.getBoolean(com.glview.R.styleable.AbsListView_stackFromBottom, false);
        setStackFromBottom(stackFromBottom);

        boolean scrollingCacheEnabled = a.getBoolean(com.glview.R.styleable.AbsListView_scrollingCache, true);
        setScrollingCacheEnabled(scrollingCacheEnabled);

        boolean useTextFilter = a.getBoolean(com.glview.R.styleable.AbsListView_textFilterEnabled, false);
        setTextFilterEnabled(useTextFilter);

        int transcriptMode = a.getInt(com.glview.R.styleable.AbsListView_transcriptMode,
                TRANSCRIPT_MODE_DISABLED);
        setTranscriptMode(transcriptMode);

        int color = a.getColor(com.glview.R.styleable.AbsListView_cacheColorHint, 0);
        ...
        setChoiceMode(a.getInt(com.glview.R.styleable.AbsListView_choiceMode, CHOICE_MODE_NONE));
...
//        setAlwaysDrawnWithCacheEnabled(false);
    ...
    private void useDefaultSelector() {
        setSelector(GLContext.get().getResources().getDrawable(
    ...
    private void drawSelector(GLCanvas canvas) {
    ...
    public void setSelector(int resID) {
        setSelector(GLContext.get().getResources().getDrawable(resID));
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (mTextFilterEnabled && !mGlobalLayoutListenerAddedFilter) {
