...
import com.glview.view.animation.DecelerateInterpolator;
...
public class EdgeEffect {
    ...
    public EdgeEffect(Context context) {
        ...
        mShader = new LinearGradient(0, 0, 0, 0, 0xFFFF0000, 0x00000000, TileMode.CLAMP);
...
//        mShader.setPoint(centerX, 0);
//        mShader.setSize(mBounds.width(), mBounds.height());
        mShader.setPosition(0, 0, 0, mBounds.height());
