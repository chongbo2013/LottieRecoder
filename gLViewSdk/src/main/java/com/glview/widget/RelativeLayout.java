...
import com.glview.util.pools.Pool;
import com.glview.util.pools.Poolable;
import com.glview.util.pools.PoolableManager;
import com.glview.util.pools.Pools;
 ...
 * {@link com.ViewGroup.image.view.GLViewGroup.LayoutParams#WRAP_CONTENT WRAP_CONTENT} and a child set to
 ...
 *
 * <p>
 * Also see {@link com.aliyun.image.widget.RelativeLayout.LayoutParams RelativeLayout.GLLayoutParams} for
 * layout attributes
 * </p>
 *
 */
public class RelativeLayout extends ViewGroup {
    ...
    private static final String LOG_TAG = "GLRelativeLayout";
...
//    private GLView mBaselineView = null;
...
//    }
    ...
    /**
     * Defines which GLView is ignored when the gravity is applied. This setting has no
     * effect if the gravity is <code>Gravity.START | Gravity.TOP</code>.
     *
     * @param viewId The id of the GLView to be ignored by gravity, or 0 if no GLView
     *        should be ignored.
     *
     * @see #setGravity(int)
     *
...
//    }
    ...
    private void sortChildren() {
        ...
        if (DEBUG_GRAPH) {
            ...
            graph.log(getContext().getResources(), RULES_VERTICAL);
            d(LOG_TAG, "=== Sorted horizontal children");
            graph.log(getContext().getResources(), RULES_HORIZONTAL);
        }
        ...
        if (DEBUG_GRAPH) {
            ...
            for (View view : mSortedVerticalChildren) {
                DependencyGraph.printViewId(getContext().getResources(), view);
            }
...
//                if (child.getVisibility() != GONE) {
//                    GLLayoutParams params = (GLLayoutParams) child.getLayoutParams();
...
//
//        if (anchorBaseline != -1) {
//            GLLayoutParams anchorParams = getRelatedViewParams(rules, ALIGN_BASELINE);
...
//            mBaselineView = child;
//        } else {
//            GLLayoutParams lp = (GLLayoutParams) mBaselineView.getLayoutParams();
...
//        }
     ...
     * stored in its GLLayoutParams. If any of these values is -1 it means that the view
     * can extend up to the corresponding edge.
     *
     * @param child Child to measure
     * @param params GLLayoutParams associated with child
     ...
     * the GLView's desired dimension.
     *
...
//        GLView v = getRelatedView(rules, relation);
//        if (v != null) {
...
//    }
     ...
     * {@link android.view.LayoutParams.GLLayoutParams#WRAP_CONTENT},
     * a height of {@link android.view.LayoutParams.GLLayoutParams#WRAP_CONTENT} and no spanning.
     */
    @Override
    ...
    // Override to allow type-checking of GLLayoutParams.
    @Override
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
			...
			for (int i = 0; i < N; i++) {
				...
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_toLeftOf) {
					rules[LEFT_OF] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_toRightOf) {
					rules[RIGHT_OF] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_above) {
					rules[ABOVE] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_below) {
					rules[BELOW] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignBaseline) {
					rules[ALIGN_BASELINE] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignLeft) {
					rules[ALIGN_LEFT] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignTop) {
					rules[ALIGN_TOP] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignRight) {
					rules[ALIGN_RIGHT] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignBottom) {
					rules[ALIGN_BOTTOM] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignParentLeft) {
					rules[ALIGN_PARENT_LEFT] = a.getBoolean(attr, false) ? TRUE
							: 0;
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignParentTop) {
					rules[ALIGN_PARENT_TOP] = a.getBoolean(attr, false) ? TRUE
							: 0;
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignParentRight) {
					rules[ALIGN_PARENT_RIGHT] = a.getBoolean(attr, false) ? TRUE
							: 0;
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignParentBottom) {
					rules[ALIGN_PARENT_BOTTOM] = a.getBoolean(attr, false) ? TRUE
							: 0;
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_centerInParent) {
					rules[CENTER_IN_PARENT] = a.getBoolean(attr, false) ? TRUE
							: 0;
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_centerHorizontal) {
					rules[CENTER_HORIZONTAL] = a.getBoolean(attr, false) ? TRUE
							: 0;
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_centerVertical) {
					rules[CENTER_VERTICAL] = a.getBoolean(attr, false) ? TRUE
							: 0;
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_toStartOf) {
					rules[START_OF] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_toEndOf) {
					rules[END_OF] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignStart) {
					rules[ALIGN_START] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignEnd) {
					rules[ALIGN_END] = a.getResourceId(attr, 0);
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignParentStart) {
					rules[ALIGN_PARENT_START] = a.getBoolean(attr, false) ? TRUE
							: 0;
				} else if (attr == com.glview.R.styleable.RelativeLayout_Layout_layout_alignParentEnd) {
        ...
        public String debug(String output) {
            return output + "GLViewGroup.GLLayoutParams={ width=" + sizeToString(width) +
         ...
         *        {@link com.aliyun.image.widget.RelativeLayout RelativeLayout}, such as
