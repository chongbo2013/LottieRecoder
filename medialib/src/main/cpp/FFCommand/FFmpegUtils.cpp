...
static const char * const RETRIEVER_CLASS_NAME = "com/ferris/medialib/FFmpegUtils";
...
static int register_com_ferris_medialib_FFmpegUtils(JNIEnv *env) {
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if (register_com_ferris_medialib_FFmpegUtils(env) != JNI_OK) {
        return -1;
    }
