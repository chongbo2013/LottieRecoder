...
JNICALL
Java_com_ferris_media_SkottieRunner_nCreateProxy(JNIEnv *env, jclass clazz) {
...
JNICALL
Java_com_ferris_media_SkottieRunner_nDeleteProxy(JNIEnv *env, jclass clazz, jlong nativeProxy) {
    if (!nativeProxy) {
        return;
    }
...
extern "C" JNIEXPORT jlong
JNICALL
Java_com_ferris_media_SkottieRunner_00024SkottieAnimationImpl_nCreateProxy(JNIEnv *env,
                                                                           jobject clazz,
                                                                           jlong runner,
                                                                           jobject bufferObj) {
...
extern "C" JNIEXPORT void
JNICALL
Java_com_ferris_media_SkottieRunner_00024SkottieAnimationImpl_nDeleteProxy(JNIEnv *env, jclass clazz,
                                                                       jlong nativeProxy) {
    if (!nativeProxy) {
        return;
    }
...
JNICALL
Java_com_ferris_media_SkottieRunner_00024SkottieAnimationImpl_nDrawFrame(JNIEnv *env, jclass clazz,
...
extern "C" JNIEXPORT jlong
JNICALL
Java_com_ferris_media_SkottieRunner_00024SkottieAnimationImpl_nGetDuration(JNIEnv *env,
                                                                           jclass clazz,
                                                                           jlong nativeProxy) {
    if (!nativeProxy) {
        return 0;
